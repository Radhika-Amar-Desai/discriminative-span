...
def analyze(V, logger):
    ...
    logger.info("Computing SVD for rank diagnostics...")
    ...
    logger.info(f"Stable rank: {stable_rank:.4f}")

    # --------------------------------------------------
    # Effective Rank
    # r_eff = exp( entropy of normalized singular values )
    # --------------------------------------------------
    ...
    logger.info(f"Effective rank: {effective_rank:.4f}")
