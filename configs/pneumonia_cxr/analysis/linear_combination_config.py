...
EMBEDDINGS = {
    ...
    "l1": {
        ...
        "resnet18": {
            "real_A": os.path.join(BASE_REAL_DATA_DIR, 'resnet18', 'NORMAL'),
            "synthetic_B": os.path.join(L1_SCALED_SYNTHETIC_DATA_DIR, 'resnet18', 'PNEUMONIA'),
            "real_B": os.path.join(BASE_REAL_DATA_DIR, 'resnet18', 'PNEUMONIA')
        },

        "clip": {
            "real_A": os.path.join(BASE_REAL_DATA_DIR, 'clip', 'NORMAL'),
            "synthetic_B": os.path.join(L1_SCALED_SYNTHETIC_DATA_DIR, 'clip', 'PNEUMONIA'),
            "real_B": os.path.join(BASE_REAL_DATA_DIR, 'clip', 'PNEUMONIA')
        },

        "dinov2": {
            "real_A": os.path.join(BASE_REAL_DATA_DIR, 'dinov2', 'NORMAL'),
            "synthetic_B": os.path.join(L1_SCALED_SYNTHETIC_DATA_DIR, 'dinov2', 'PNEUMONIA'),
            "real_B": os.path.join(BASE_REAL_DATA_DIR, 'dinov2', 'PNEUMONIA')
        }
