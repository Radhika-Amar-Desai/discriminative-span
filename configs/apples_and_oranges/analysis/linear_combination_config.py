...
BASE_DATA_DIR = r'C:\Users\97433\Knowing_the_difference\data\embeddings\apples_and_oranges'
BASE_SYNTHETIC_DATA_DIR = os.path.join(BASE_DATA_DIR, 'synthetic_corrupted_data')
