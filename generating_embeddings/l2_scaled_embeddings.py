...
def setup_logger(log_file):
    ...
    logger = logging.getLogger("l2_classifier_logger")
...
#     # ------------------------------------------------
#     # Select 50% subset for L2 training
#     # ------------------------------------------------
...
#     logger.info("L2 training subset selection")
#     logger.info(f"Total samples              : {total_samples}")
#     logger.info(f"Training samples used for L2 : {len(train_indices)}")
...
def process_embedding_folder(
    ...
    if use_pretrained:
        ...
        logger.info("No pretrained classifier found — training L2 Logistic Regression")
...
def main():
    ...
    run_id, _, log_file = log_run(
        ...
        base_output_dir=os.path.dirname(OUTPUT_LOG_DIR)
    )

    logger = setup_logger(log_file)

    logger.info("====================================")
    logger.info("L2 Logistic Regression Scaling")
    ...
    #     config.L2_SCALED_DINOV2_EMBEDDING_FOLDER,
    #     C_VALUE,
    #     logger
    # )
    ...
    #     config.L2_SCALED_RESNET18_EMBEDDING_FOLDER,
    #     C_VALUE,
    #     logger
    # )
    ...
    #     config.L2_SCALED_CLIP_EMBEDDING_FOLDER,
    #     C_VALUE,
    #     logger
    # )
