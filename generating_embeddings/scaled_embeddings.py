...
#     logger.info(" training subset selection")
#     logger.info(f"Total samples              : {total_samples}")
#     logger.info(f"Training samples used for  : {len(train_indices)}")
...
def process_embedding_folder(
    ...
    if use_pretrained:
        ...
        logger.info("No pretrained classifier found — training  Logistic Regression")
...
def main():
    ...
    logger.info("====================================")
    logger.info(" Logistic Regression Scaling")
    ...
    #     config.SCALED_DINOV2_EMBEDDING_FOLDER,
    #     C_VALUE,
    #     logger
    # )
    ...
    #     config.SCALED_RESNET18_EMBEDDING_FOLDER,
    #     C_VALUE,
    #     logger
    # )
    ...
    #     config.SCALED_CLIP_EMBEDDING_FOLDER,
    #     C_VALUE,
    #     logger
    # )
